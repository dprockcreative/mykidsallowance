...
class Form_AdminUser extends Zend_Form {
	...
	public function init() {
		...
		$this->setAttrib('id', 'adminuser_form')->setMethod('post');

		$this->addElement('hash', 'no_csrf_adminuser', array('ignore' => true, 'salt' => 'unique', 'decorators' => $this->_d->hidden));
	...
	public function loadDefaultDecorators() {
		...
		$this->addSubForms(array('Members' => new Form_AdminMembers()));
	...
	private function _multiOptions($switch = '', $var = null) {
		...
		switch($switch) {
			case 'group_id':
				$goptions 	= Core_Acl_Roles::getGroupOptions(true);
				$options 	= $goptions;
			break;
		}
...
/* Location: ./application/forms/AdminUser.php */